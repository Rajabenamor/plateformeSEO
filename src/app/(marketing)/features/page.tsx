      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {FEATURE_LIST.map((f, i) => (
            <div key={i} className="group p-8 bg-card/50 backdrop-blur-xl border border-white/5 rounded-2xl shadow-sm hover:border-primary/50 transition-all">
              ...
              <h3 className="text-xl font-bold text-foreground mb-4 tracking-tight">{f.title}</h3>
