      ...
      <div className="max-w-4xl mx-auto relative z-10 bg-card/50 backdrop-blur-xl border border-white/5 shadow-sm rounded-2xl overflow-hidden">
        ...
        <div className="p-8 md:p-16 space-y-16">
          ...
          <nav className="bg-white/5 p-8 rounded-2xl border border-white/5 shadow-inner">
            <h2 className="text-[10px] font-bold uppercase tracking-wider text-slate-600 mb-6">
              Navigation
            </h2>
            <ul className="grid md:grid-cols-2 gap-x-8 gap-y-3 text-sm font-bold text-slate-400">
              ...
              <li>
                <a
                  ...
                  className="hover:text-accent transition-colors flex items-center gap-2"
                >
                  <div className="h-1 w-1 rounded-full bg-accent" /> Data
                  Controller
                </a>
              </li>
              <li>
                <a
                  ...
                  className="hover:text-accent transition-colors flex items-center gap-2"
                >
                  <div className="h-1 w-1 rounded-full bg-accent" /> 1. Data We
                  Collect
                </a>
              </li>
              <li>
                <a
                  ...
                  className="hover:text-accent transition-colors flex items-center gap-2"
                >
                  <div className="h-1 w-1 rounded-full bg-accent" /> 2. How We
                  Use Data
                </a>
              </li>
              <li>
                <a
                  ...
                  className="hover:text-accent transition-colors flex items-center gap-2"
                >
                  <div className="h-1 w-1 rounded-full bg-accent" /> 3. Your
                  Rights
                </a>
              </li>
              <li>
                <a
                  ...
                  className="hover:text-accent transition-colors flex items-center gap-2"
                >
                  <div className="h-1 w-1 rounded-full bg-accent" /> 4. Security
                  Measures
                </a>
              </li>
            </ul>
          ...
          <section id="intro">
            ...
            <p className="leading-relaxed text-slate-500 dark:text-slate-400 font-medium">
              Welcome to STRIVE. We respect your privacy and are committed to
          ...
          >
            <div>
              <h3 className="text-[10px] font-bold uppercase tracking-wider text-slate-600 mb-4">
                Data Controller
              </h3>
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-accent font-bold">
                <Mail size={16} />
                <a
                  href="mailto:strive.company.support@gmail.com"
          ...
          <section id="collection">
            ...
            <ul className="space-y-4 text-slate-500 dark:text-slate-400 font-medium text-sm">
              ...
              <li className="flex items-start gap-3">
                <div className="h-1.5 w-1.5 rounded-full bg-primary mt-1.5 shrink-0" />
                <span>
                  <strong>Contact Data:</strong> Email address and billing
                  address.
                </span>
              </li>
              <li className="flex items-start gap-3">
          ...
          <section id="usage">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-white/5 rounded-2xl border border-white/5 text-xs font-bold uppercase tracking-wider text-slate-400">
          ...
          >
            ...
            <p className="text-slate-500 dark:text-slate-400 font-medium leading-relaxed text-sm">
              ...
              those employees and third parties who have a business need to
              know.
            </p>
          </section>
          ...
          <footer className="pt-16 border-t border-white/5 text-center">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm mb-8 font-medium">
              ...
              practices, please contact our data team.
            </p>
            <a
              href="mailto:strive.company.support@gmail.com"
              className="bg-primary text-white px-10 py-4 rounded-xl font-bold hover:bg-primary/90 transition-all shadow-lg shadow-primary/20 inline-block text-xs uppercase tracking-wider"
            >
              Email Privacy Team
            </a>
          </footer>
