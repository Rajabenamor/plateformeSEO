    ...
    <div className="min-h-screen bg-background text-foreground py-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-8 bg-card/50 backdrop-blur-xl border border-white/5 rounded-2xl shadow-sm hover:border-primary/50 transition-all group">
            ...
            <h3 className="font-bold text-xl mb-4 tracking-tight">The Mission</h3>
          ...
          <div className="p-8 bg-card/50 backdrop-blur-xl border border-white/5 rounded-2xl shadow-sm hover:border-primary/50 transition-all group">
            ...
            <h3 className="font-bold text-xl mb-4 tracking-tight">The Tech</h3>
          ...
          <div className="p-8 bg-card/50 backdrop-blur-xl border border-white/5 rounded-2xl shadow-sm hover:border-primary/50 transition-all group">
            ...
            <h3 className="font-bold text-xl mb-4 tracking-tight">The Result</h3>
