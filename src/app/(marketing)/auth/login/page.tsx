...
import { GoogleLoginAction, loginServerAction } from "@/app/actions/auth";
        ...
        <div className="hidden md:flex flex-col justify-between p-12 bg-primary/5 border-r border-white/5">
          <div>
            <Image
              ...
              priority
            />
            <h1 className="text-4xl lg:text-5xl font-bold text-foreground leading-[1.1] mb-6 mt-23 tracking-tight">
              Precision analytics for the{" "}
              <span className="text-accent">modern web</span>
            </h1>
            <p className="text-slate-400 text-lg leading-relaxed max-w-md">
              Transform raw data into architectural intelligence. Our suite of
              technical SEO tools provides the blueprint for your digital
              growth.
            </p>
          </div>
        </div>
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center">
          <div className="mb-10 text-center md:text-left">
            ...
            <p className="text-slate-400 font-medium">
              Log in to your SEO intelligence dashboard.
            </p>
          </div>
