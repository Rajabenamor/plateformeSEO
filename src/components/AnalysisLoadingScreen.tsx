...
export function AnalysisLoadingScreen({
  ...
  const step2Status =
    progress < 30 ? "pending" : progress < 70 ? "active" : "complete";
      ...
      <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] max-w-3xl w-full p-10 relative overflow-hidden border border-gray-100">
        <div className="flex flex-col items-center text-center mb-10 mt-4">
          ...
          <p className="text-muted-foreground text-sm">
            We are performing a comprehensive scan of{" "}
            <span className="font-semibold text-foreground">{targetUrl}</span>
          </p>
        </div>
        ...
        {progress >= 95 && (
          <div className="text-center mb-8 animate-pulse">
            <p className="text-sm text-primary font-medium italic">
              Finalizing deep analysis... This may take a moment for larger
              sites.
            </p>
          </div>
        )}
